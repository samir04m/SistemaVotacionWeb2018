...
INSERT INTO `Usuario`(`nombre`, `segundoNombre`, `apellido`, `segundoApellido`, `codigo`, `identificacion`, 
`email`, `telefono`, `password`, `Programa_idPrograma`, `Estado_idEstado`, `Rol_idRol`) VALUES
('Admin','is','tra','dor','2015101010','12340000','admin@gmail.com','301231231','1234',1,1,1),
('Juan','Pablo','Avila','Martinez','2015114030','11112222','juan@gmail.com','301231231','1122',2,2,2);
